...
Line 5: Final line for testing`;
  ...
  try {
    ...
    console.log(
      "2. Navigate to line 2 (press j or down arrow in navigation mode)",
    );
    console.log('3. Press "dd" (d twice quickly) to delete the current line');
    console.log(
      '4. The line "Line 2: This line will be deleted" should disappear',
    );
    console.log("5. Test with other lines to verify functionality");
    console.log(
      "6. Press F1 to see the help dialog and verify the shortcut is documented",
    );
    console.log("7. Press Ctrl+X to exit when done testing");

    console.log("\n🎯 Expected Behavior:");
    console.log(
      '- "dd" (press d twice quickly) deletes the current line in navigation mode',
    );
    console.log("- Cursor adjusts position appropriately");
    console.log("- Undo (Ctrl+Z) should restore deleted lines");
    console.log("- Only works in navigation mode (not insert mode)");
